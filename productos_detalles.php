    ...
    if ($row = $res->fetch_assoc()) {
        ...
        <body>
            ...
            <table>
                ...
                <tr><th>Codigo:</th><td><?php echo $codigo; ?></td></tr>
                <tr><th>Descripcion:</th><td><?php echo $descripcion; ?></td></tr>
                <tr><th>Costo:</th><td><?php echo $costo; ?></td></tr>
                <tr><th>Stock:</th><td><?php echo $stock; ?></td></tr>
